...
for (i in 1:k) {
  set.seed(21072022+i)
  wald_dat <- geracao(n = n, alpha = 1, beta = 2, p = 0.5)
...
tab_result_0.9 <- rbind(
  wald_0.9_10 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.9_20 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.9_30 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.9_50 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
)
...
tab_result_0.95 <- rbind(
  wald_0.95_10 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.95_20 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.95_30 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.95_50 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
)
...
tab_result_0.99 <- rbind(
  wald_0.99_10 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.99_20 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.99_30 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
  , wald_0.99_50 %>% as.matrix.noquote() %>% unname() %>% t() %>% round(4)
)
